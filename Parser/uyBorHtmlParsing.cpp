...
UyBorHtmlParsing::UyBorHtmlParsing()
{
...
QString UyBorHtmlParsing::getToken(QByteArray arr)
{
    QGumboDocument document = QGumboDocument::parse(arr);
    QGumboNode root = document.rootNode(); //передаем тег <html> в root
    QGumboNodes contentDiv = root.getElementById("content");
...
QString UyBorHtmlParsing::getId(QByteArray arr)
{
    QGumboDocument document = QGumboDocument::parse(arr);
...
QList<QString> UyBorHtmlParsing::phoneList(QByteArray arr)
{
